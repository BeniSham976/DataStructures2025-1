...
public class SupplierLinkList {
     ...
     */
    public void add(Supplier value){
        // VALIDATION
        if(value == null){
    ...
    public void add(Supplier value, int pos){
        // VALIDATION:
        // Nulls are not permitted - throw exception if one is provided
        if(value == null){
            throw new IllegalArgumentException("List cannot handle null elements.");
     ...
     * @throws IllegalArgumentException if the value to be added is null
     */
    public void addFirst(Supplier value){
        // VALIDATION:
        // Nulls are not permitted - throw exception if one is provided
        if(value == null){
            throw new IllegalArgumentException("List cannot handle null elements.");
